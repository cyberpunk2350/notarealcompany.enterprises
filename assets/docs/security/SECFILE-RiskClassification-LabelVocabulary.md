...
**Filed Under:** Internal Security reference material — companion to SECFILE template
...
**On uniqueness:** Each subject receives one label. Do not stack labels. If a subject seems to warrant multiple labels, select the one that implies the others most efficiently.

**On the unlabeled file:** Victor Watchful's own security file, if it exists, has not been assigned a label from this vocabulary. Whether that is because no label applies, because the label is classified above the level of this document, or because the file does not exist is not established. This is noted.
...
*Consolidated BR-003v4, 2026-04-20. Sources archived at:*
*`narc-lore-build/branches/BR-003 - Staff Dossiers/Risk Classification Label Generation/`*
