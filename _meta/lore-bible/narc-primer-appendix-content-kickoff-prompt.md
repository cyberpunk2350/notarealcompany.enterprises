...
> **Document type:** Author-facing reference — operational prompt template for external content generation sessions.
> **Purpose:** A ready-to-send prompt that establishes the correct reading sequence, format references, voice compliance rules, and task handoff structure for any session generating blog posts or document artifacts for the NARC website.
> **Cross-references:** Section 04 (Document Naming Convention), Section 05 (Document Templates Part A), Section 06 (Document Templates Part B), Section 08 (Blog Post Styles)
> **Source:** Generated by an external session (2026-04-24) after context refresh from current lore bible state. Reviewed and adjusted BR-003v4, 2026-04-20.
> **Adjustments from source:** Section 08 existence confirmed (stale "known issue" note corrected); format reference guidance clarified re: known lore violations in older hybrid posts; SECFILE document series added; usage notes separated from prompt body.
